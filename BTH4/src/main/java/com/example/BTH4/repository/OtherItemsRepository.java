...
public interface OtherItemsRepository extends JpaRepository<OtherItems, Integer> {
	...
	@Query("SELECT new com.example.BTH4.response.OtherItemsResponse(o.id, o.order.id, o.product_id, o.product_name, o.quantity, o.unit_price, o.total_price) FROM OtherItems o")
	List<OtherItemsResponse> findAllOtherItems();
	
	@Query("SELECT new com.example.BTH4.response.OtherItemsResponse(o.id, o.order.id, o.product_id, o.product_name, o.quantity, o.unit_price, o.total_price) FROM OtherItems o WHERE o.product_id = :product_id")
	Optional<OtherItemsResponse> findByProductId(@Param("product_id") int product_id);

	@Query("SELECT new com.example.BTH4.response.OtherItemsResponse(o.id, o.order.id, o.product_id, o.product_name, o.quantity, o.unit_price, o.total_price) FROM OtherItems o WHERE o.order.id = :order_id")
